...
namespace Atk.CustomExpression
{
    internal abstract class ExpressionVisitor
    {
        ...
        protected virtual Expression Visit(System.Linq.Expressions.Expression exp)
        {
            if (exp == null)
                return exp;
            switch (exp.NodeType)
        ...
        protected virtual Expression VisitUnknown(System.Linq.Expressions.Expression expression)
        {
